...
<%@ include file="/common/web/homelib.jsp"%>
...
<header class="header mb-5">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offer mb-3 mb-lg-0">
					<a href="#" class="btn btn-success btn-sm">Offer of the day</a><a
						href="#" class="ml-1">Get flat 35% off on orders over $50!</a>
				</div>
	...
	<nav class="navbar navbar-expand-lg">
		<div class="container">
			...
			<img src="<c:url value='/images/logo.png" alt="Obaju logo" class="d-none d-md-inline-block'/>"></img>
			<img src="<c:url value='/images/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none'/>"> </img>
			...
			<div id="navigation" class="collapse navbar-collapse">
				<ul class="navbar-nav mr-auto">
						...
						<ul class="dropdown-menu megamenu">
							<li>
								<div class="row">
									...
									<div class="col-md-6 col-lg-3">
										<div class="banner">
											<a href="#"><img src="<c:url value='/images/banner.jpg" alt="" class="img img-fluid'/>"></a>
										</div>
										<div class="banner">
											<a href="#"><img src="<c:url value='/images/banner2.jpg" alt="" class="img img-fluid'/>"></a>
										</div>
									</div>
								</div>
							</li>
					...
					<li class="nav-item dropdown menu-large"><a href="#"
						data-toggle="dropdown" data-hover="dropdown" data-delay="200"
						class="dropdown-toggle nav-link">Template<b class="caret"></b></a>
						<ul class="dropdown-menu megamenu">
							<li>
								<div class="row">
									<div class="col-md-6 col-lg-3">
									...
									<div class="col-md-6 col-lg-3">
										...
										<ul class="list-unstyled mb-3">
											...
											<li class="nav-item"><a href="post.html"
				...
				<div class="navbar-buttons d-flex justify-content-end">
					...
					<div id="basket-overview"
						...
						<a href="basket.html" class="btn btn-primary navbar-btn"><i
							class="fa fa-shopping-cart"></i><span>3 items in cart</span></a>
					</div>
				</div>
			</div>
		</div>
