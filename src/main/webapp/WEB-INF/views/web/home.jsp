				...
				<div class="row">
					<div class="col-md-12">
						<div id="main-slider" class="owl-carousel owl-theme">
							<div class="item">
								<img src="<c:url value='/images/main-slider1.jpg" alt="" class="img-fluid'/>">
							</div>
							<div class="item">
								<img src="<c:url value='/images/main-slider2.jpg" alt="" class="img-fluid'/>">
							</div>
							<div class="item">
								<img src="<c:url value='/images/main-slider3.jpg" alt="" class="img-fluid'/>">
							</div>
							<div class="item">
								<img src="<c:url value='/images/main-slider4.jpg" alt="" class="img-fluid'/>">
							</div>
						</div>
						<!-- /#main-slider-->
					</div>
					...
					<div class="row mb-4">
						<div class="col-md-4">
							<div
								...
								<p class="mb-0">We are known to provide best possible
									service ever</p>
							</div>
						</div>
						<div class="col-md-4">
							<div
								...
								<p class="mb-0">You can check that the height of the boxes
									adjust when longer text like this one is used in one of them.</p>
							</div>
						</div>
						<div class="col-md-4">
							<div
				...
				<div class="col-md-12">
					<div class="box slideshow">
						...
						<div id="get-inspired" class="owl-carousel owl-theme">
							<div class="item">
								<a href="#"><img src="<c:url value='/images/getinspired1.jpg" alt="Get inspired" class="img-fluid'/>"></a>
							</div>
							<div class="item">
								<a href="#"><img src="<c:url value='/images/getinspired2.jpg" alt="Get inspired" class="img-fluid'/>"></a>
							</div>
							<div class="item">
								<a href="#"><img src="<c:url value='/images/getinspired3.jpg" alt="Get inspired" class="img-fluid'/>"></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="box text-center">
				<div class="container">
					<div class="col-md-12">
						...
						<p class="lead mb-0">
							What's new in the world of fashion? <a href="blog.html">Check
								our blog!</a>
						</p>
					</div>
				</div>
						...
						<div class="col-sm-6">
							<div class="post">
								...
								<p class="author-category">
									By <a href="#">John Slim</a> in <a href="">Fashion and
										style</a>
								</p>
								<hr>
								...
								<p class="read-more">
									<a href="post.html" class="btn btn-primary">Continue
										reading</a>
								</p>
							</div>
						</div>
