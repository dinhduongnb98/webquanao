						...
						<div id="productMain" class="row">
							<div class="col-md-6">
								<div data-slider-id="1"
									...
									<div class="item">
										<img src="<c:url value='/images/detailbig1.jpg" alt="" class="img-fluid'/>">
									</div>
									<div class="item">
										<img src="<c:url value='/images/detailbig2.jpg" alt="" class="img-fluid'/>">
									</div>
									<div class="item">
										<img src="<c:url value='/images/detailbig3.jpg" alt="" class="img-fluid'/>">
									</div>
								</div>
